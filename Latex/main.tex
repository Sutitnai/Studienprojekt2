...
% -----------------------------------------------------------------------------------
 ...
 \thesisType{Studienprojekt Sustainable Systems Engeneering}
 \thesisTitle{Einsatz von MEMS-Sensoren zur Erdbebenüberwachung: Untersuchung der Anwendbarkeit}
 \submitDate{16.09.2024}
...
\begin{document}
    ...
    % Cover page
    % -------------------------------------------------------------------------------
    \input{settings+/front_matter/covers/cover}                     \clearpage
